...
LMICWrapper stores LoRaWAN messages into a deque object (STL). Each time runloopOnce() is called, a LMIC callback job is registered to send first
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc5NTQ2MDcwNSwtMTcxMDczNzA2Miw2Nj
